...
export default function ChangePassword() {
  ...
  const updatePassword = (
    <>
      <Box width="80%" m={1}>
        <Password label="Digite a senha atual" passwordIsValid={oldPasswordIsValid} setPassword={setOldPassword} />
      </Box>
      <Box width="80%" m={1}>
        <Password label="Digite a nova senha" passwordIsValid={newPasswordIsValid} setPassword={setNewPassword} />
      </Box>
      {/* Error */}
      <Box mt={2}>
